...
#if UNITY_WP8
			if (Assets.Plugins.GoogleAnalyticsWP8.sharedManager().GetLogScreenViewDelegate() != null)
			{
				Assets.Plugins.GoogleAnalyticsWP8.sharedManager().GetLogScreenViewDelegate().Invoke(screenName);
			}
#else

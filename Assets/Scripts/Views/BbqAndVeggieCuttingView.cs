...
public class BbqAndVeggieCuttingView : MonoBehaviour {
    ...
    void Start () {
		ShowAd ();
		GameManager.instance.currentScene = GameUtils.BBQANDVEGGIECUTTINGVIEW;
	...
	private void KnifeListenerOn(){
		...
		if (pieceCounter <= 3) {
            ...
            knifeCutPoints[pieceCounter].GetComponent<BoxCollider2D>().enabled = true;
